package br.com.kt.mockito.services

import br.com.kt.MockPerson
...
class PersonServiceTest {
    ...
    fun findAllPerson() {
        ...
        val persons = service.findAllPerson()
    ...
    fun findPersonById() {
        ...
        val result = service.findPersonById(1)
    ...
    fun createWithNullPerson() {
        val exception: Exception = assertThrows(
                RequiredObjectIsNotFoundException::class.java
        ) {service.create(null)}
